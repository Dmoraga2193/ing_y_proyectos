...
const ContactSection: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.mensaje) newErrors.mensaje = "Mensaje es requerido";
    setErrors(newErrors);
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="group w-full h-full">
              <div className="relative h-full">
                <img
                  ...
                  className="w-full h-full lg:rounded-l-2xl rounded-l-2xl bg-blend-multiply bg-indigo-700"
                />
          ...
          <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-r-2xl">
            ...
            <form onSubmit={sendEmail}>
              <div className="mb-10">
                {errors.nombre && (
                  <p className="text-red-500 mb-2">{errors.nombre}</p>
                )}
                <input
                  type="text"
                  name="nombre"
              ...
              <div className="mb-10">
                {errors.mensaje && (
                  <p className="text-red-500 mb-2">{errors.mensaje}</p>
                )}
                <textarea
                  name="mensaje"
                  className="w-full h-32 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-lg border border-gray-200 focus:outline-none pl-4"
                  placeholder="Mensaje"
